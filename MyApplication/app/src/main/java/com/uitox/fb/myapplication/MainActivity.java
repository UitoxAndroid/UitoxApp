...
public class MainActivity extends ActionBarActivity {
    ...
    */
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        toast = Toast.makeText(MainActivity.this, "onRestoreInstanceState!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        toast = Toast.makeText(MainActivity.this, "onSaveInstanceState!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onDestroy() {
        super.onDestroy();
        toast = Toast.makeText(MainActivity.this, "onDestroy!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onResume()
    {
        ...
        toast = Toast.makeText(MainActivity.this, "onResume!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onPause()
    {
        ...
        toast = Toast.makeText(MainActivity.this, "onPause!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onStart() {
        super.onStart();
        toast = Toast.makeText(MainActivity.this, "onStart!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onRestart() {
        super.onRestart();
        toast = Toast.makeText(MainActivity.this, "onRestart!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onStop() {
        super.onStop();
        toast = Toast.makeText(MainActivity.this, "onStop!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    */
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        toast = Toast.makeText(MainActivity.this, "onActivityResult!~1", Toast.LENGTH_SHORT);
        toast.show();
    }
