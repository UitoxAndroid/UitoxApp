...
public class GCM {
     ...
     */
    public final static String SENDER_ID = "682033767380";
     ...
     */
    public static void sendLocalNotification(Context context, int notifyID, int drawableSmallIcon, String title, String msg, String info, boolean autoCancel, PendingIntent pendingIntent) {
        NotificationManager mNotificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);

        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context).setSmallIcon(drawableSmallIcon).setContentTitle(title)
    ...
    public GCM(Activity activity, GCMListener listener) {
        this.activity = activity;
        setGCMListener(listener);
    }
    ...
    public void setGCMListener(GCMListener listener) {
    ...
    public String getRegistrationId() {
        ...
        // 檢查程式是否有更新過
        int registeredVersion = prefs.getInt(GCM.PROPERTY_APP_VERSION, Integer.MIN_VALUE);
